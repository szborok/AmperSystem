//URL: components/sections/Hero.tsx

import Link from "next/link";
import { ShieldCheck, Zap, Clock, Phone } from "lucide-react";
import { companyInfo } from "@/data/companyInfo";

// Update the component to accept translations as props
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="text-orange">{translations.hero.heroTitle1}</span>
          </h1>
          <p className="text-lg md:text-xl mb-10 text-gray-200 max-w-2xl">
            {translations.hero.heroText1}
          </p>

          <div className="flex flex-col md:flex-row gap-8 mb-12">
            {[
              { icon: ShieldCheck, text: translations.hero.heroCard1 },
              { icon: Zap, text: translations.hero.heroCard2 },
              { icon: Clock, text: translations.hero.heroCard3 },
            ].map((item, index) => (
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            ...
            >
              <span>{translations.hero.heroButton1}</span>
            ...
            >
              ...
              <span>{translations.hero.heroButton2}</span>
            </Link>
          </div>
        </div>
      </div>
